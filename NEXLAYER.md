# Nexlayer — pure-eagle-purrfectly-zen-astro

**Live:** [https://xenial-tern-pure-eagle-purrfectly-zen-astro.qa.cluster.vibeship.work](https://xenial-tern-pure-eagle-purrfectly-zen-astro.qa.cluster.vibeship.work)  

**Runtime:** astro · **Port:** 80 · **Deploy branch:** main

---

## How this deployment works

**pure-eagle-purrfectly-zen-astro** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01krc1n44dd49btzyv6vht92v2/purrfectly-zen-astro:9fb5130-fix2"
      path: /
      servicePorts:
        - 3000
      vars:
